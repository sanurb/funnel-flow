    ...
    <>
      <section className="h-full w-full pt-36 relative flex items-center justify-center flex-col">
        ...
        <div className="md:mt-[200px]">
          <p className="mt-12 text-center">Run your agency, in one place</p>

          <div className="bg-gradient-to-r from-primary to-secondary-foreground text-transparent bg-clip-text relative">
            <h1 className="text-8xl font-bold text-center md:text-xxl">
              Funnel Flow
            </h1>
          </div>
        </div>
      ...
      <section className="flex justify-center items-center flex-col gap-4 md:!mt-[17rem] mt-[160px]">
            ...
            <CardFooter className="flex flex-col  items-start gap-4 ">
              <div>
                {pricingCards
                  ...
                  ?.features.map((feature) => (
                    <div key={feature} className="justify-start items-center gap-3 inline-flex">
                      <Check />
                      <p>{feature}</p>
                    </div>
                  ))}
